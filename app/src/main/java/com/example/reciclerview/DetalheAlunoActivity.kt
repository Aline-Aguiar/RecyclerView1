...
class DetalheAlunoActivity : AppCompatActivity() {
    ...
    val toolbarAluno by lazy { findViewById<Toolbar>(R.id.toolbar_alunos) }
    ...
    val imagemViewAluno by lazy { findViewById<ImageView>(R.id.img_activity) }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detalhe_aluno)

        setSupportActionBar(toolbarAluno)
